...
assert(animals === 'cool', 'That\'s right, they\'re cool little guys.');
assert(theMan, 'The man is false.');
...
var num = Math.floor(Math.random() * (favoriteAnimals.length));
...
assert(animalExhibitStats.mostPopular === 'Lucky the Emperor Penguin', 'It\'s gotta be that Emperor Penguin');
